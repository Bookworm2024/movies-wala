...
class script(object):
    START_TXT = """<b><blockquote>ʜᴇʟʟᴏ ᴛʜᴇʀᴇ {}, ɪ ᴀᴍ <a href=https://t.me/{}>{}</a></blockquote>
    
ɪ ᴄᴀɴ ᴘʀᴏᴠɪᴅᴇ ᴍᴏᴠɪᴇꜱ ᴀɴᴅ ᴡᴇʙꜱᴇʀɪᴇꜱ ᴛᴏ ᴜꜱᴇʀꜱ ᴡʜᴏ ʀᴇQᴜᴇꜱᴛ ᴛʜᴇᴍ ꜰʀᴏᴍ ᴍᴇ. ʏᴏᴜ ᴄᴀɴ ᴀᴅᴅ ᴍᴇ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ ᴡɪᴛʜ ᴀʟʟ ᴛʜᴇ ᴀᴅᴍɪɴ ʀɪɢʜᴛꜱ ᴀɴᴅ ɪ ꜱʜᴀʟʟ ᴡᴏʀᴋ ᴛʜᴇʀᴇ ᴀꜱ ᴡᴇʟʟ.\n\nɪ ᴄᴀɴ ᴄʀᴇᴀᴛᴇ ᴍʏ ʟɪᴛᴛʟᴇ ᴄʜɪʟᴅʀᴇɴ ᴀꜱ ᴡᴇʟʟ ᴡʜᴏ ᴡᴏᴜʟᴅ ᴡᴏʀᴋ ᴜɴᴅᴇʀ ʏᴏᴜ. ᴜꜱᴇ ᴛʜᴇ /clone ᴄᴏᴍᴍᴀɴᴅ ᴛᴏ ᴄʀᴇᴀᴛᴇ ᴍʏ ᴄᴏᴘɪᴇꜱ.</b>"""

    CLONE_START_TXT = """<b><blockquote>ʜᴇʟʟᴏ ᴛʜᴇʀᴇ {}, ɪ ᴀᴍ <a href=https://t.me/{}>{}</a></blockquote>
    
ɪ ᴀᴍ ᴀᴅᴠᴀɴᴄᴇ ᴀɴᴅ ᴘᴏᴡᴇʀғᴜʟʟ ᴀᴜᴛᴏғɪʟᴛᴇʀ ʙᴏᴛ ᴡɪᴛʜ ᴀᴍᴀᴢɪɴɢ ғᴇᴀᴛᴜʀᴇs ᴊᴜsᴛ ᴛʏᴘᴇ ᴡʜᴀᴛ ʏᴏᴜ ᴡᴀɴᴛ & ᴛʜᴇɴ sᴇᴇ ᴍʏ ᴘᴏᴡᴇʀ 💘</b>"""
    
    HELP_TXT = """<b>Hᴇʏ {}
ꜰᴏʟʟᴏᴡɪɴɢ Is Tʜᴇ Hᴇʟᴘ Fᴏʀ Mʏ Cᴏᴍᴍᴀɴᴅs.</b>"""

    ABOUT_TXT = """<b><blockquote>⍟───[ MY ᴅᴇᴛᴀɪʟꜱ ]───⍟</blockquote>
    
‣ ᴍʏ ɴᴀᴍᴇ : <a href=https://t.me/{}>{}</a>
‣ ᴍʏ ʙᴇsᴛ ғʀɪᴇɴᴅ : <a href='tg://settings'>ᴛʜɪs ᴘᴇʀsᴏɴ</a> 
‣ ᴅᴇᴠᴇʟᴏᴘᴇʀ : <a href='https://t.me/infohub_updates'>ɪɴꜰᴏʜᴜʙ ɴᴇᴛᴡᴏʀᴋꜱ</a> 
...
👨‍💻 Cᴏᴍᴍᴀɴᴅ : /clone</b>"""
    ...
    SUBSCRIPTION_TXT = """
<b>ʀᴇғᴇʀʀ ʏᴏᴜʀ ʟɪɴᴋ ᴛᴏ ʏᴏᴜʀ ғʀɪᴇɴᴅs, ғᴀᴍɪʟʏ, ᴄʜᴀɴɴᴇʟ ᴀɴᴅ ɢʀᴏᴜᴘ ᴛᴏ ɢᴇᴛ ғʀᴇᴇ ᴘʀᴇᴍɪᴜᴍ ғᴏʀ {}
...
my features Stay here new features coming soon...  
 <b>✯ Maintained by : <a href=https://t.me/infohub_updates>ɪɴꜰᴏʜᴜʙ ɴᴇᴛᴡᴏʀᴋꜱ</a></b>
  
 <b>✯ Join here : <a href=https://t.me/infohub_updates>☢Join my updates☢</a></b> 
...
ʀᴇQᴜᴇꜱᴛ ʏᴏᴜʀꜱ"""
    ...
    OLD_ALRT_TXT = """ʜᴇʏ {},
ʏᴏᴜ ᴀʀᴇ ᴜꜱɪɴɢ ᴏɴᴇ ᴏꜰ ᴍʏ ᴏʟᴅ ʀᴇᴘʟɪᴇꜱ, 
...
ஏய் <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 
 ...
 படி 1: இந்த The Devil's Theatre போட் உங்கள் குழுவை நிர்வாகியாக்குங்கள்
...
Hey <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 
 ...
 Step 1: Administer this The Devil's Theatre bot to your group
...
హే <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 
 ...
 దశ 1: ఈ The Devil's Theatre బాట్‌ని మీ సమూహానికి నిర్వహించండి
...
अरे <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 
 ...
 चरण 1: इस The Devil's Theatre बॉट को अपने समूह में प्रशासित करें
...
ഹേയ് <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 
 ...
 ഘട്ടം 1: ഈ The Devil's Theatre ബോട്ട് നിങ്ങളുടെ ഗ്രൂപ്പിലേക്ക് നൽകുക
...
നിങ്ങളുടെ ടീം വീഡിയോ ശേഖരണവും പരിശീലിപ്പിക്കും..."""
 ...
 مرحلہ 1: اپنے گروپ میں اس The Devil's Theatre بوٹ کا انتظام کریں۔
...
અરે <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 
 ...
 પગલું 1: તમારા જૂથમાં આ The Devil's Theatre બોટનું સંચાલન કરો
...
ಹೇ {message.from_user.mention}
 ...
 ಹಂತ 1: ಈ The Devil's Theatre ಬೋಟ್ ಅನ್ನು ನಿಮ್ಮ ಗುಂಪಿಗೆ ನಿರ್ವಹಿಸಿ
...
আরে <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 
 ...
 ধাপ 1: আপনার গ্রুপে এই The Devil's Theatre বট পরিচালনা করুন
...
-Dev 1 [Owner of this bot ]<a href='https://t.me/the_universal_being'>ᏰᎧᎧᏦᏇᎧᏒᎷ</a>

-Dev 2 <a href='https://t.me/infohub_updates'>InfoHub Updates</a>

-Dev 3 <a href='https://t.me/ridhiigandhii'>Ridhi</a>

- Dev 4 <a href='https://t.me/infohub_updates'>InfoHub Networks</a>
"""
